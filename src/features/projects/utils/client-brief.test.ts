...
function createProject(overrides: Partial<ProjectPreview> = {}): ProjectPreview {
  return {
    ...
    actual_hours: 80,
    baseline_hours: 320,
    hours_consumed_percent: 25,
    expected_progress_percent: 25,
    hours_variance_percent: 0,
    forecast_at_completion_percent: 100,
    budget_amount: 125000,
    progress_percent: 25,
    risk_status: 'green',
    risk_reason: 'Delivery progress is aligned with the approved baseline',
    status: 'active',
    completed_at: null,
