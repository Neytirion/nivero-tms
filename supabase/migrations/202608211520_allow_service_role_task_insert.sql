-- Allow backend service_role inserts for tasks (used by public client intake edge function).
-- Keeps existing member-level assignment rules for regular authenticated users.
