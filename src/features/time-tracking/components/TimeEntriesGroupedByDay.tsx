...
export function TimeEntriesGroupedByDay({
  ...
  return (
    <div className="overflow-x-auto rounded-lg border border-slate-200">
        <div className="hidden min-w-[760px] grid-cols-[minmax(220px,2fr)_minmax(90px,0.8fr)_minmax(90px,0.8fr)_minmax(90px,0.8fr)_56px] border-b border-slate-200 bg-slate-50 px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-slate-500 sm:grid">
