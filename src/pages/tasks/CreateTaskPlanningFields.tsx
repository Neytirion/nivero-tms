  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
      ...
      <div className="mt-3 space-y-3">
        <div>
          <label className="mb-1 block text-sm font-medium text-slate-700">Estimated hours (optional)</label>
          <input
            type="number"
            min="0"
            step="0.5"
          ...
          />
          <p className="mt-1 text-[11px] text-slate-500">Time needed to complete this task, if known.</p>
        </div>
